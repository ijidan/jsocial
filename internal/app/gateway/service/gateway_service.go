...
import (
	...
	"github.com/ijidan/jsocial/internal/pkg/dispatch"
...
func NewGatewayService(cf config.Rpc) *GatewayService {
	instance := &GatewayService{BasicService: service.BasicService{
