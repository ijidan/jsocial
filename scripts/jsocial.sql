...
-- 导出 jsocial 的数据库结构
CREATE DATABASE IF NOT EXISTS `jsocial` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `jsocial`;

-- 导出  表 jsocial.device 结构
CREATE TABLE IF NOT EXISTS `device` (
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='设备';

-- 正在导出表  jsocial.device 的数据：~1 rows (大约)
INSERT IGNORE INTO `device` (`id`, `device_id`, `app_id`, `user_id`, `type`, `brand`, `model`, `system_version`, `sdk_version`, `status`, `conn_addr`, `conn_fd`, `create_time`, `update_time`) VALUES
	(1, 1, 1, 1, 2, 'apple', ' ', ' ', ' ', 0, '127.0.0.1', 1, '2021-11-09 12:04:18', '2021-11-09 12:04:21');

-- 导出  表 jsocial.device_ack 结构
CREATE TABLE IF NOT EXISTS `device_ack` (
    ...
    UNIQUE KEY `uk_device_id` (`device_id`) USING BTREE
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='设备消息同步序列号';

-- 正在导出表  jsocial.device_ack 的数据：~0 rows (大约)

-- 导出  表 jsocial.feed 结构
...
-- 正在导出表  jsocial.feed 的数据：~0 rows (大约)

-- 导出  表 jsocial.feed_image 结构
CREATE TABLE IF NOT EXISTS `feed_image` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='动态图片';

-- 正在导出表  jsocial.feed_image 的数据：~0 rows (大约)

-- 导出  表 jsocial.feed_like 结构
...
-- 正在导出表  jsocial.feed_like 的数据：~0 rows (大约)

-- 导出  表 jsocial.feed_video 结构
CREATE TABLE IF NOT EXISTS `feed_video` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='动态视频';

-- 正在导出表  jsocial.feed_video 的数据：~0 rows (大约)
...
CREATE TABLE IF NOT EXISTS `gid` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='分布式自增主键';

-- 正在导出表  jsocial.gid 的数据：~0 rows (大约)

-- 导出  表 jsocial.goadmin_menu 结构
...
-- 正在导出表  jsocial.goadmin_menu 的数据：~8 rows (大约)
INSERT IGNORE INTO `goadmin_menu` (`id`, `parent_id`, `type`, `order`, `title`, `icon`, `uri`, `header`, `plugin_name`, `uuid`, `created_at`, `updated_at`) VALUES
	(1, 0, 1, 2, 'Admin', 'fa-tasks', '', NULL, '', NULL, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(2, 1, 1, 2, 'Users', 'fa-users', '/info/manager', NULL, '', NULL, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(3, 1, 1, 3, 'Roles', 'fa-user', '/info/roles', NULL, '', NULL, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(4, 1, 1, 4, 'Permission', 'fa-ban', '/info/permission', NULL, '', NULL, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(5, 1, 1, 5, 'Menu', 'fa-bars', '/menu', NULL, '', NULL, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(6, 1, 1, 6, 'Operation log', 'fa-history', '/info/op', NULL, '', NULL, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(7, 0, 1, 1, 'Dashboard', 'fa-bar-chart', '/', NULL, '', NULL, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(8, 0, 0, 2, '用户', 'fa-blind', '/user', '', '', NULL, '2022-01-26 01:24:29', '2022-01-26 01:24:29');

-- 导出  表 jsocial.goadmin_operation_log 结构
...
-- 正在导出表  jsocial.goadmin_operation_log 的数据：~96 rows (大约)
INSERT IGNORE INTO `goadmin_operation_log` (`id`, `user_id`, `path`, `method`, `ip`, `input`, `created_at`, `updated_at`) VALUES
	(1, 1, '/admin', 'GET', '127.0.0.1', '', '2022-01-26 01:23:10', '2022-01-26 01:23:10'),
	(2, 1, '/admin/info/roles', 'GET', '127.0.0.1', '', '2022-01-26 01:23:18', '2022-01-26 01:23:18'),
	(3, 1, '/admin/menu', 'GET', '127.0.0.1', '', '2022-01-26 01:23:32', '2022-01-26 01:23:32'),
	(4, 1, '/admin/menu/new', 'POST', '127.0.0.1', '{"__go_admin_previous_":["/admin/menu"],"__go_admin_t_":["e3e75eee-f679-4c22-9365-641d6c280396"],"header":[""],"icon":["fa-blind"],"parent_id":["0"],"plugin_name":[""],"title":["用户"],"uri":["/user"]}', '2022-01-26 01:24:29', '2022-01-26 01:24:29'),
	(5, 1, '/admin', 'GET', '127.0.0.1', '', '2022-01-26 01:26:52', '2022-01-26 01:26:52'),
	(6, 1, '/admin/info/manager', 'GET', '127.0.0.1', '', '2022-01-26 01:27:03', '2022-01-26 01:27:03'),
	(7, 1, '/admin/info/roles', 'GET', '127.0.0.1', '', '2022-01-26 01:28:50', '2022-01-26 01:28:50'),
	(8, 1, '/admin', 'GET', '127.0.0.1', '', '2022-01-26 01:34:01', '2022-01-26 01:34:01'),
	(9, 1, '/admin/application/info', 'GET', '127.0.0.1', '', '2022-01-26 01:34:15', '2022-01-26 01:34:15'),
	(10, 1, '/admin/application/info', 'GET', '127.0.0.1', '', '2022-01-26 01:34:21', '2022-01-26 01:34:21'),
	(11, 1, '/admin/plugins', 'GET', '127.0.0.1', '', '2022-01-26 01:34:30', '2022-01-26 01:34:30'),
	(12, 1, '/admin/plugins/store', 'GET', '127.0.0.1', '', '2022-01-26 01:34:39', '2022-01-26 01:34:39'),
	(13, 1, '/admin/plugins', 'GET', '127.0.0.1', '', '2022-01-26 01:34:55', '2022-01-26 01:34:55'),
	(14, 1, '/admin', 'GET', '127.0.0.1', '', '2022-01-26 01:37:12', '2022-01-26 01:37:12'),
	(15, 1, '/admin/plugins', 'GET', '127.0.0.1', '', '2022-01-26 01:37:41', '2022-01-26 01:37:41'),
	(16, 1, '/admin/plugins/store', 'GET', '127.0.0.1', '', '2022-01-26 01:37:43', '2022-01-26 01:37:43'),
	(17, 1, '/admin/info/site/edit', 'GET', '127.0.0.1', '', '2022-01-26 01:37:46', '2022-01-26 01:37:46'),
	(18, 1, '/admin/info/generate/new', 'GET', '127.0.0.1', '', '2022-01-26 01:37:54', '2022-01-26 01:37:54'),
	(19, 1, '/admin/application/info', 'GET', '127.0.0.1', '', '2022-01-26 01:37:56', '2022-01-26 01:37:56'),
	(20, 1, '/admin/application/info', 'GET', '127.0.0.1', '', '2022-01-26 01:37:59', '2022-01-26 01:37:59'),
	(21, 1, '/admin', 'GET', '127.0.0.1', '', '2022-01-26 01:38:02', '2022-01-26 01:38:02'),
	(22, 1, '/admin', 'GET', '127.0.0.1', '', '2022-01-26 01:38:04', '2022-01-26 01:38:04'),
	(23, 1, '/admin/info/op', 'GET', '127.0.0.1', '', '2022-01-26 01:38:08', '2022-01-26 01:38:08'),
	(24, 1, '/admin/menu', 'GET', '127.0.0.1', '', '2022-01-26 01:38:09', '2022-01-26 01:38:09'),
	(25, 1, '/admin/info/permission', 'GET', '127.0.0.1', '', '2022-01-26 01:38:10', '2022-01-26 01:38:10'),
	(26, 1, '/admin/info/roles', 'GET', '127.0.0.1', '', '2022-01-26 01:38:11', '2022-01-26 01:38:11'),
	(27, 1, '/admin/info/op', 'GET', '127.0.0.1', '', '2022-01-26 01:38:13', '2022-01-26 01:38:13'),
	(28, 1, '/admin', 'GET', '127.0.0.1', '', '2022-01-26 01:38:15', '2022-01-26 01:38:15'),
	(29, 1, '/admin', 'GET', '127.0.0.1', '', '2022-01-26 01:52:51', '2022-01-26 01:52:51'),
	(30, 1, '/admin/info/user', 'GET', '127.0.0.1', '', '2022-01-26 01:53:06', '2022-01-26 01:53:06'),
	(31, 1, '/admin/info/user', 'GET', '127.0.0.1', '', '2022-01-26 01:53:33', '2022-01-26 01:53:33'),
	(32, 1, '/admin/info/user', 'GET', '127.0.0.1', '', '2022-01-26 01:53:35', '2022-01-26 01:53:35'),
	(33, 1, '/admin/info/group_user', 'GET', '127.0.0.1', '', '2022-01-26 01:53:56', '2022-01-26 01:53:56'),
	(34, 1, '/admin', 'GET', '::1', '', '2022-01-26 01:55:44', '2022-01-26 01:55:44'),
	(35, 1, '/admin/info/group', 'GET', '::1', '', '2022-01-26 01:55:55', '2022-01-26 01:55:55'),
	(36, 1, '/admin/info/group', 'GET', '::1', '', '2022-01-26 01:59:18', '2022-01-26 01:59:18'),
	(37, 1, '/admin/info/group', 'GET', '::1', '', '2022-01-26 01:59:25', '2022-01-26 01:59:25'),
	(38, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 01:59:29', '2022-01-26 01:59:29'),
	(39, 1, '/admin/info/user/edit', 'GET', '::1', '', '2022-01-26 01:59:33', '2022-01-26 01:59:33'),
	(40, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 01:59:41', '2022-01-26 01:59:41'),
	(41, 1, '/admin/info/goup', 'GET', '::1', '', '2022-01-26 01:59:45', '2022-01-26 01:59:45'),
	(42, 1, '/admin/info/goup_a', 'GET', '::1', '', '2022-01-26 01:59:52', '2022-01-26 01:59:52'),
	(43, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:00:05', '2022-01-26 02:00:05'),
	(44, 1, '/admin/info/message', 'GET', '::1', '', '2022-01-26 02:00:08', '2022-01-26 02:00:08'),
	(45, 1, '/admin/info/group', 'GET', '::1', '', '2022-01-26 02:00:11', '2022-01-26 02:00:11'),
	(46, 1, '/admin/info/group', 'GET', '::1', '', '2022-01-26 02:00:32', '2022-01-26 02:00:32'),
	(47, 1, '/admin/info/group', 'GET', '::1', '', '2022-01-26 02:00:53', '2022-01-26 02:00:53'),
	(48, 1, '/admin/info/group', 'GET', '::1', '', '2022-01-26 02:02:42', '2022-01-26 02:02:42'),
	(49, 1, '/admin/info/group', 'GET', '::1', '', '2022-01-26 02:03:46', '2022-01-26 02:03:46'),
	(50, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:04:39', '2022-01-26 02:04:39'),
	(51, 1, '/admin/info/user/edit', 'GET', '::1', '', '2022-01-26 02:04:45', '2022-01-26 02:04:45'),
	(52, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:06:01', '2022-01-26 02:06:01'),
	(53, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:08:29', '2022-01-26 02:08:29'),
	(54, 1, '/admin/info/user/edit', 'GET', '::1', '', '2022-01-26 02:08:32', '2022-01-26 02:08:32'),
	(55, 1, '/admin/info/group', 'GET', '::1', '', '2022-01-26 02:10:35', '2022-01-26 02:10:35'),
	(56, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:11:19', '2022-01-26 02:11:19'),
	(57, 1, '/admin/info/user/detail', 'GET', '::1', '', '2022-01-26 02:33:23', '2022-01-26 02:33:23'),
	(58, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:33:27', '2022-01-26 02:33:27'),
	(59, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:35:45', '2022-01-26 02:35:45'),
	(60, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:37:14', '2022-01-26 02:37:14'),
	(61, 1, '/admin/export/user', 'POST', '::1', '', '2022-01-26 02:37:33', '2022-01-26 02:37:33'),
	(62, 1, '/admin/info/user/detail', 'GET', '::1', '', '2022-01-26 02:38:24', '2022-01-26 02:38:24'),
	(63, 1, '/admin/info/user/edit', 'GET', '::1', '', '2022-01-26 02:38:28', '2022-01-26 02:38:28'),
	(64, 1, '/admin/info/user/detail', 'GET', '::1', '', '2022-01-26 02:38:29', '2022-01-26 02:38:29'),
	(65, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:39:34', '2022-01-26 02:39:34'),
	(66, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:43:19', '2022-01-26 02:43:19'),
	(67, 1, '/admin/export/user', 'POST', '::1', '', '2022-01-26 02:43:23', '2022-01-26 02:43:23'),
	(68, 1, '/admin/info/user', 'GET', '::1', '', '2022-01-26 02:51:02', '2022-01-26 02:51:02'),
	(69, 1, '/admin/plugins', 'GET', '::1', '', '2022-01-26 02:51:06', '2022-01-26 02:51:06'),
	(70, 1, '/admin/plugins/store', 'GET', '::1', '', '2022-01-26 02:51:09', '2022-01-26 02:51:09'),
	(71, 1, '/admin/plugin/download', 'POST', '::1', '', '2022-01-26 02:51:14', '2022-01-26 02:51:14'),
	(72, 1, '/admin/plugin/download', 'POST', '::1', '', '2022-01-26 02:51:21', '2022-01-26 02:51:21'),
	(73, 1, '/admin', 'GET', '::1', '', '2022-01-26 02:58:48', '2022-01-26 02:58:48'),
	(74, 1, '/admin/plugins/store', 'GET', '::1', '', '2022-01-26 02:58:51', '2022-01-26 02:58:51'),
	(75, 1, '/admin/plugins/store', 'GET', '::1', '', '2022-01-26 02:58:53', '2022-01-26 02:58:53'),
	(76, 1, '/admin/info/plugin_filemanager/new', 'GET', '::1', '', '2022-01-26 02:58:54', '2022-01-26 02:58:54'),
	(77, 1, '/admin/info/plugin_filemanager/new', 'GET', '::1', '', '2022-01-26 02:58:55', '2022-01-26 02:58:55'),
	(78, 1, '/admin/plugins/store', 'GET', '::1', '', '2022-01-26 02:59:02', '2022-01-26 02:59:02'),
	(79, 1, '/admin/info/plugin_librarian/new', 'GET', '::1', '', '2022-01-26 02:59:03', '2022-01-26 02:59:03'),
	(80, 1, '/admin/info/plugin_librarian/new', 'GET', '::1', '', '2022-01-26 02:59:03', '2022-01-26 02:59:03'),
	(81, 1, '/admin', 'GET', '127.0.0.1', '', '2022-01-26 23:24:16', '2022-01-26 23:24:16'),
	(82, 1, '/admin/info/user', 'GET', '127.0.0.1', '', '2022-01-26 23:24:51', '2022-01-26 23:24:51'),
	(83, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:24:57', '2022-01-26 23:24:57'),
	(84, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:27:31', '2022-01-26 23:27:31'),
	(85, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:29:42', '2022-01-26 23:29:42'),
	(86, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:35:07', '2022-01-26 23:35:07'),
	(87, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:35:07', '2022-01-26 23:35:07'),
	(88, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:39:00', '2022-01-26 23:39:00'),
	(89, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:41:52', '2022-01-26 23:41:52'),
	(90, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:44:45', '2022-01-26 23:44:45'),
	(91, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:45:26', '2022-01-26 23:45:26'),
	(92, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:47:32', '2022-01-26 23:47:32'),
	(93, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-26 23:57:45', '2022-01-26 23:57:45'),
	(94, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-27 00:00:24', '2022-01-27 00:00:24'),
	(95, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-27 00:15:46', '2022-01-27 00:15:46'),
	(96, 1, '/admin/info/group', 'GET', '127.0.0.1', '', '2022-01-27 00:15:48', '2022-01-27 00:15:48');

-- 导出  表 jsocial.goadmin_permissions 结构
...
-- 正在导出表  jsocial.goadmin_permissions 的数据：~58 rows (大约)
INSERT IGNORE INTO `goadmin_permissions` (`id`, `name`, `slug`, `http_method`, `http_path`, `created_at`, `updated_at`) VALUES
	(1, 'All permission', '*', '', '*', '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(2, 'Dashboard', 'dashboard', 'GET,PUT,POST,DELETE', '/', '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(3, 'device 查询', 'device_query', 'GET', '/info/device', '2022-01-26 01:41:58', '2022-01-26 01:41:58'),
	(4, 'device 编辑页显示', 'device_show_edit', 'GET', '/info/device/edit', '2022-01-26 01:41:58', '2022-01-26 01:41:58'),
	(5, 'device 新建记录页显示', 'device_show_create', 'GET', '/info/device/new', '2022-01-26 01:41:58', '2022-01-26 01:41:58'),
	(6, 'device 编辑', 'device_edit', 'POST', '/edit/device', '2022-01-26 01:41:58', '2022-01-26 01:41:58'),
	(7, 'device 新建', 'device_create', 'POST', '/new/device', '2022-01-26 01:41:58', '2022-01-26 01:41:58'),
	(8, 'device 删除', 'device_delete', 'POST', '/delete/device', '2022-01-26 01:41:58', '2022-01-26 01:41:58'),
	(9, 'device 导出', 'device_export', 'POST', '/export/device', '2022-01-26 01:41:59', '2022-01-26 01:41:59'),
	(10, 'device_ack 查询', 'device_ack_query', 'GET', '/info/device_ack', '2022-01-26 01:41:59', '2022-01-26 01:41:59'),
	(11, 'device_ack 编辑页显示', 'device_ack_show_edit', 'GET', '/info/device_ack/edit', '2022-01-26 01:41:59', '2022-01-26 01:41:59'),
	(12, 'device_ack 新建记录页显示', 'device_ack_show_create', 'GET', '/info/device_ack/new', '2022-01-26 01:41:59', '2022-01-26 01:41:59'),
	(13, 'device_ack 编辑', 'device_ack_edit', 'POST', '/edit/device_ack', '2022-01-26 01:41:59', '2022-01-26 01:41:59'),
	(14, 'device_ack 新建', 'device_ack_create', 'POST', '/new/device_ack', '2022-01-26 01:41:59', '2022-01-26 01:41:59'),
	(15, 'device_ack 删除', 'device_ack_delete', 'POST', '/delete/device_ack', '2022-01-26 01:42:00', '2022-01-26 01:42:00'),
	(16, 'device_ack 导出', 'device_ack_export', 'POST', '/export/device_ack', '2022-01-26 01:42:00', '2022-01-26 01:42:00'),
	(17, 'gid 查询', 'gid_query', 'GET', '/info/gid', '2022-01-26 01:42:00', '2022-01-26 01:42:00'),
	(18, 'gid 编辑页显示', 'gid_show_edit', 'GET', '/info/gid/edit', '2022-01-26 01:42:00', '2022-01-26 01:42:00'),
	(19, 'gid 新建记录页显示', 'gid_show_create', 'GET', '/info/gid/new', '2022-01-26 01:42:00', '2022-01-26 01:42:00'),
	(20, 'gid 编辑', 'gid_edit', 'POST', '/edit/gid', '2022-01-26 01:42:01', '2022-01-26 01:42:01'),
	(21, 'gid 新建', 'gid_create', 'POST', '/new/gid', '2022-01-26 01:42:01', '2022-01-26 01:42:01'),
	(22, 'gid 删除', 'gid_delete', 'POST', '/delete/gid', '2022-01-26 01:42:01', '2022-01-26 01:42:01'),
	(23, 'gid 导出', 'gid_export', 'POST', '/export/gid', '2022-01-26 01:42:01', '2022-01-26 01:42:01'),
	(24, 'group 查询', 'group_query', 'GET', '/info/group', '2022-01-26 01:42:01', '2022-01-26 01:42:01'),
	(25, 'group 编辑页显示', 'group_show_edit', 'GET', '/info/group/edit', '2022-01-26 01:42:02', '2022-01-26 01:42:02'),
	(26, 'group 新建记录页显示', 'group_show_create', 'GET', '/info/group/new', '2022-01-26 01:42:02', '2022-01-26 01:42:02'),
	(27, 'group 编辑', 'group_edit', 'POST', '/edit/group', '2022-01-26 01:42:02', '2022-01-26 01:42:02'),
	(28, 'group 新建', 'group_create', 'POST', '/new/group', '2022-01-26 01:42:02', '2022-01-26 01:42:02'),
	(29, 'group 删除', 'group_delete', 'POST', '/delete/group', '2022-01-26 01:42:02', '2022-01-26 01:42:02'),
	(30, 'group 导出', 'group_export', 'POST', '/export/group', '2022-01-26 01:42:02', '2022-01-26 01:42:02'),
	(31, 'group_user 查询', 'group_user_query', 'GET', '/info/group_user', '2022-01-26 01:42:03', '2022-01-26 01:42:03'),
	(32, 'group_user 编辑页显示', 'group_user_show_edit', 'GET', '/info/group_user/edit', '2022-01-26 01:42:03', '2022-01-26 01:42:03'),
	(33, 'group_user 新建记录页显示', 'group_user_show_create', 'GET', '/info/group_user/new', '2022-01-26 01:42:03', '2022-01-26 01:42:03'),
	(34, 'group_user 编辑', 'group_user_edit', 'POST', '/edit/group_user', '2022-01-26 01:42:03', '2022-01-26 01:42:03'),
	(35, 'group_user 新建', 'group_user_create', 'POST', '/new/group_user', '2022-01-26 01:42:03', '2022-01-26 01:42:03'),
	(36, 'group_user 删除', 'group_user_delete', 'POST', '/delete/group_user', '2022-01-26 01:42:04', '2022-01-26 01:42:04'),
	(37, 'group_user 导出', 'group_user_export', 'POST', '/export/group_user', '2022-01-26 01:42:04', '2022-01-26 01:42:04'),
	(38, 'message 查询', 'message_query', 'GET', '/info/message', '2022-01-26 01:42:04', '2022-01-26 01:42:04'),
	(39, 'message 编辑页显示', 'message_show_edit', 'GET', '/info/message/edit', '2022-01-26 01:42:04', '2022-01-26 01:42:04'),
	(40, 'message 新建记录页显示', 'message_show_create', 'GET', '/info/message/new', '2022-01-26 01:42:04', '2022-01-26 01:42:04'),
	(41, 'message 编辑', 'message_edit', 'POST', '/edit/message', '2022-01-26 01:42:05', '2022-01-26 01:42:05'),
	(42, 'message 新建', 'message_create', 'POST', '/new/message', '2022-01-26 01:42:05', '2022-01-26 01:42:05'),
	(43, 'message 删除', 'message_delete', 'POST', '/delete/message', '2022-01-26 01:42:05', '2022-01-26 01:42:05'),
	(44, 'message 导出', 'message_export', 'POST', '/export/message', '2022-01-26 01:42:05', '2022-01-26 01:42:05'),
	(45, 'user 查询', 'user_query', 'GET', '/info/user', '2022-01-26 01:42:05', '2022-01-26 01:42:05'),
	(46, 'user 编辑页显示', 'user_show_edit', 'GET', '/info/user/edit', '2022-01-26 01:42:05', '2022-01-26 01:42:05'),
	(47, 'user 新建记录页显示', 'user_show_create', 'GET', '/info/user/new', '2022-01-26 01:42:05', '2022-01-26 01:42:05'),
	(48, 'user 编辑', 'user_edit', 'POST', '/edit/user', '2022-01-26 01:42:06', '2022-01-26 01:42:06'),
	(49, 'user 新建', 'user_create', 'POST', '/new/user', '2022-01-26 01:42:06', '2022-01-26 01:42:06'),
	(50, 'user 删除', 'user_delete', 'POST', '/delete/user', '2022-01-26 01:42:06', '2022-01-26 01:42:06'),
	(51, 'user 导出', 'user_export', 'POST', '/export/user', '2022-01-26 01:42:06', '2022-01-26 01:42:06'),
	(52, 'group_a 查询', 'group_a_query', 'GET', '/info/group_a', '2022-01-26 01:50:56', '2022-01-26 01:50:56'),
	(53, 'group_a 编辑页显示', 'group_a_show_edit', 'GET', '/info/group_a/edit', '2022-01-26 01:50:56', '2022-01-26 01:50:56'),
	(54, 'group_a 新建记录页显示', 'group_a_show_create', 'GET', '/info/group_a/new', '2022-01-26 01:50:57', '2022-01-26 01:50:57'),
	(55, 'group_a 编辑', 'group_a_edit', 'POST', '/edit/group_a', '2022-01-26 01:50:57', '2022-01-26 01:50:57'),
	(56, 'group_a 新建', 'group_a_create', 'POST', '/new/group_a', '2022-01-26 01:50:57', '2022-01-26 01:50:57'),
	(57, 'group_a 删除', 'group_a_delete', 'POST', '/delete/group_a', '2022-01-26 01:50:57', '2022-01-26 01:50:57'),
	(58, 'group_a 导出', 'group_a_export', 'POST', '/export/group_a', '2022-01-26 01:50:57', '2022-01-26 01:50:57');

-- 导出  表 jsocial.goadmin_roles 结构
...
-- 正在导出表  jsocial.goadmin_roles 的数据：~2 rows (大约)
INSERT IGNORE INTO `goadmin_roles` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
	(1, 'Administrator', 'administrator', '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(2, 'Operator', 'operator', '2019-09-09 16:00:00', '2019-09-09 16:00:00');

-- 导出  表 jsocial.goadmin_role_menu 结构
...
-- 正在导出表  jsocial.goadmin_role_menu 的数据：~5 rows (大约)
INSERT IGNORE INTO `goadmin_role_menu` (`role_id`, `menu_id`, `created_at`, `updated_at`) VALUES
	(1, 1, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(1, 7, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(2, 7, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(1, 8, '2019-09-11 02:20:55', '2019-09-11 02:20:55'),
	(2, 8, '2019-09-11 02:20:55', '2019-09-11 02:20:55');

-- 导出  表 jsocial.goadmin_role_permissions 结构
...
-- 正在导出表  jsocial.goadmin_role_permissions 的数据：~3 rows (大约)
INSERT IGNORE INTO `goadmin_role_permissions` (`role_id`, `permission_id`, `created_at`, `updated_at`) VALUES
	(1, 1, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(1, 2, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(2, 2, '2019-09-09 16:00:00', '2019-09-09 16:00:00');

-- 导出  表 jsocial.goadmin_role_users 结构
...
-- 正在导出表  jsocial.goadmin_session 的数据：~1 rows (大约)
INSERT IGNORE INTO `goadmin_session` (`id`, `sid`, `values`, `created_at`, `updated_at`) VALUES
	(16, 'c033b5a8-0795-461e-ae75-bfccd2f5e37a', '{"user_id":1}', '2022-01-26 23:24:16', '2022-01-26 23:24:16');

-- 导出  表 jsocial.goadmin_site 结构
...
-- 正在导出表  jsocial.goadmin_site 的数据：~68 rows (大约)
INSERT IGNORE INTO `goadmin_site` (`id`, `key`, `value`, `description`, `state`, `created_at`, `updated_at`) VALUES
	(1, 'app_id', 'dwJRmCKHDriverVu7', NULL, 1, '2022-01-26 01:22:19', '2022-01-26 01:22:19'),
	(2, 'env', 'local', NULL, 1, '2022-01-26 01:22:19', '2022-01-26 01:22:19'),
	(3, 'error_log_path', 'E:/go_project/jim_admin/logs/error.log', NULL, 1, '2022-01-26 01:22:19', '2022-01-26 01:22:19'),
	(4, 'info_log_off', 'false', NULL, 1, '2022-01-26 01:22:20', '2022-01-26 01:22:20'),
	(5, 'file_upload_engine', '{"name":"local"}', NULL, 1, '2022-01-26 01:22:20', '2022-01-26 01:22:20'),
	(6, 'prohibit_config_modification', 'false', NULL, 1, '2022-01-26 01:22:20', '2022-01-26 01:22:20'),
	(7, 'sql_log', 'false', NULL, 1, '2022-01-26 01:22:20', '2022-01-26 01:22:20'),
	(8, 'logger_encoder_duration', '', NULL, 1, '2022-01-26 01:22:21', '2022-01-26 01:22:21'),
	(9, 'animation_type', '', NULL, 1, '2022-01-26 01:22:21', '2022-01-26 01:22:21'),
	(10, 'language', 'cn', NULL, 1, '2022-01-26 01:22:21', '2022-01-26 01:22:21'),
	(11, 'logger_level', '0', NULL, 1, '2022-01-26 01:22:21', '2022-01-26 01:22:21'),
	(12, 'custom_head_html', '', NULL, 1, '2022-01-26 01:22:22', '2022-01-26 01:22:22'),
	(13, 'animation_delay', '0.00', NULL, 1, '2022-01-26 01:22:22', '2022-01-26 01:22:22'),
	(14, 'allow_del_operation_log', 'false', NULL, 1, '2022-01-26 01:22:22', '2022-01-26 01:22:22'),
	(15, 'debug', 'true', NULL, 1, '2022-01-26 01:22:22', '2022-01-26 01:22:22'),
	(16, 'bootstrap_file_path', 'E:/go_project/jim_admin/bootstrap.go', NULL, 1, '2022-01-26 01:22:22', '2022-01-26 01:22:22'),
	(17, 'mini_logo', 'JA', NULL, 1, '2022-01-26 01:22:23', '2022-01-26 01:22:23'),
	(18, 'logger_encoder_time_key', '', NULL, 1, '2022-01-26 01:22:23', '2022-01-26 01:22:23'),
	(19, 'logger_encoder_time', '', NULL, 1, '2022-01-26 01:22:23', '2022-01-26 01:22:23'),
	(20, 'login_title', 'GoAdmin', NULL, 1, '2022-01-26 01:22:23', '2022-01-26 01:22:23'),
	(21, 'operation_log_off', 'false', NULL, 1, '2022-01-26 01:22:24', '2022-01-26 01:22:24'),
	(22, 'index_url', '/', NULL, 1, '2022-01-26 01:22:24', '2022-01-26 01:22:24'),
	(23, 'access_log_off', 'false', NULL, 1, '2022-01-26 01:22:24', '2022-01-26 01:22:24'),
	(24, 'logger_encoder_message_key', '', NULL, 1, '2022-01-26 01:22:24', '2022-01-26 01:22:24'),
	(25, 'logger_encoder_level', '', NULL, 1, '2022-01-26 01:22:24', '2022-01-26 01:22:24'),
	(26, 'exclude_theme_components', 'null', NULL, 1, '2022-01-26 01:22:24', '2022-01-26 01:22:24'),
	(27, 'login_url', '/login', NULL, 1, '2022-01-26 01:22:25', '2022-01-26 01:22:25'),
	(28, 'access_log_path', 'E:/go_project/jim_admin/logs/access.log', NULL, 1, '2022-01-26 01:22:25', '2022-01-26 01:22:25'),
	(29, 'hide_plugin_entrance', 'false', NULL, 1, '2022-01-26 01:22:25', '2022-01-26 01:22:25'),
	(30, 'asset_root_path', './public/', NULL, 1, '2022-01-26 01:22:25', '2022-01-26 01:22:25'),
	(31, 'custom_404_html', '', NULL, 1, '2022-01-26 01:22:25', '2022-01-26 01:22:25'),
	(32, 'logger_encoder_name_key', '', NULL, 1, '2022-01-26 01:22:26', '2022-01-26 01:22:26'),
	(33, 'logger_encoder_stacktrace_key', '', NULL, 1, '2022-01-26 01:22:26', '2022-01-26 01:22:26'),
	(34, 'color_scheme', '', NULL, 1, '2022-01-26 01:22:26', '2022-01-26 01:22:26'),
	(35, 'asset_url', '', NULL, 1, '2022-01-26 01:22:26', '2022-01-26 01:22:26'),
	(36, 'login_logo', 'JimAdmin', NULL, 1, '2022-01-26 01:22:26', '2022-01-26 01:22:26'),
	(37, 'extra', '', NULL, 1, '2022-01-26 01:22:26', '2022-01-26 01:22:26'),
	(38, 'hide_tool_entrance', 'false', NULL, 1, '2022-01-26 01:22:26', '2022-01-26 01:22:26'),
	(39, 'custom_500_html', '', NULL, 1, '2022-01-26 01:22:27', '2022-01-26 01:22:27'),
	(40, 'logo', 'JimAdmin', NULL, 1, '2022-01-26 01:22:27', '2022-01-26 01:22:27'),
	(41, 'animation_duration', '0.00', NULL, 1, '2022-01-26 01:22:27', '2022-01-26 01:22:27'),
	(42, 'site_off', 'false', NULL, 1, '2022-01-26 01:22:27', '2022-01-26 01:22:27'),
	(43, 'go_mod_file_path', 'E:/go_project/jim_admin/go.mod', NULL, 1, '2022-01-26 01:22:28', '2022-01-26 01:22:28'),
	(44, 'logger_rotate_max_age', '0', NULL, 1, '2022-01-26 01:22:28', '2022-01-26 01:22:28'),
	(45, 'logger_rotate_compress', 'false', NULL, 1, '2022-01-26 01:22:28', '2022-01-26 01:22:28'),
	(46, 'logger_encoder_encoding', '', NULL, 1, '2022-01-26 01:22:28', '2022-01-26 01:22:28'),
	(47, 'session_life_time', '7200', NULL, 1, '2022-01-26 01:22:28', '2022-01-26 01:22:28'),
	(48, 'auth_user_table', 'goadmin_users', NULL, 1, '2022-01-26 01:22:28', '2022-01-26 01:22:28'),
	(49, 'open_admin_api', 'false', NULL, 1, '2022-01-26 01:22:29', '2022-01-26 01:22:29'),
	(50, 'logger_rotate_max_backups', '0', NULL, 1, '2022-01-26 01:22:29', '2022-01-26 01:22:29'),
	(51, 'logger_rotate_max_size', '0', NULL, 1, '2022-01-26 01:22:29', '2022-01-26 01:22:29'),
	(52, 'no_limit_login_ip', 'false', NULL, 1, '2022-01-26 01:22:29', '2022-01-26 01:22:29'),
	(53, 'theme', 'sword', NULL, 1, '2022-01-26 01:22:29', '2022-01-26 01:22:29'),
	(54, 'access_assets_log_off', 'false', NULL, 1, '2022-01-26 01:22:30', '2022-01-26 01:22:30'),
	(55, 'domain', '', NULL, 1, '2022-01-26 01:22:30', '2022-01-26 01:22:30'),
	(56, 'hide_app_info_entrance', 'false', NULL, 1, '2022-01-26 01:22:30', '2022-01-26 01:22:30'),
	(57, 'hide_visitor_user_center_entrance', 'false', NULL, 1, '2022-01-26 01:22:30', '2022-01-26 01:22:30'),
	(58, 'error_log_off', 'false', NULL, 1, '2022-01-26 01:22:31', '2022-01-26 01:22:31'),
	(59, 'logger_encoder_level_key', '', NULL, 1, '2022-01-26 01:22:31', '2022-01-26 01:22:31'),
	(60, 'logger_encoder_caller_key', '', NULL, 1, '2022-01-26 01:22:31', '2022-01-26 01:22:31'),
	(61, 'logger_encoder_caller', '', NULL, 1, '2022-01-26 01:22:31', '2022-01-26 01:22:31'),
	(62, 'custom_foot_html', '', NULL, 1, '2022-01-26 01:22:31', '2022-01-26 01:22:31'),
	(63, 'footer_info', '', NULL, 1, '2022-01-26 01:22:31', '2022-01-26 01:22:31'),
	(64, 'custom_403_html', '', NULL, 1, '2022-01-26 01:22:32', '2022-01-26 01:22:32'),
	(65, 'url_prefix', 'admin', NULL, 1, '2022-01-26 01:22:32', '2022-01-26 01:22:32'),
	(66, 'title', 'JimAdmin', NULL, 1, '2022-01-26 01:22:32', '2022-01-26 01:22:32'),
	(67, 'info_log_path', 'E:/go_project/jim_admin/logs/info.log', NULL, 1, '2022-01-26 01:22:32', '2022-01-26 01:22:32'),
	(68, 'hide_config_center_entrance', 'false', NULL, 1, '2022-01-26 01:22:32', '2022-01-26 01:22:32');

-- 导出  表 jsocial.goadmin_users 结构
...
-- 正在导出表  jsocial.goadmin_users 的数据：~2 rows (大约)
INSERT IGNORE INTO `goadmin_users` (`id`, `username`, `password`, `name`, `avatar`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'admin', '$2a$10$YK04HUCz/9ZrFceqCNpFR.wkD0Ew1Z9uVUK.ARmgqnZhyftElLAH2', 'admin', '', 'tlNcBVK9AvfYH7WEnwB1RKvocJu8FfRy4um3DJtwdHuJy0dwFsLOgAc0xUfh', '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(2, 'operator', '$2a$10$rVqkOzHjN2MdlEprRflb1eGP0oZXuSrbJLOmJagFsCd81YZm0bsh.', 'Operator', '', NULL, '2019-09-09 16:00:00', '2019-09-09 16:00:00');

-- 导出  表 jsocial.goadmin_user_permissions 结构
...
-- 正在导出表  jsocial.goadmin_user_permissions 的数据：~2 rows (大约)
INSERT IGNORE INTO `goadmin_user_permissions` (`user_id`, `permission_id`, `created_at`, `updated_at`) VALUES
	(1, 1, '2019-09-09 16:00:00', '2019-09-09 16:00:00'),
	(2, 2, '2019-09-09 16:00:00', '2019-09-09 16:00:00');

-- 导出  表 jsocial.group 结构
...
-- 正在导出表  jsocial.group 的数据：~0 rows (大约)

-- 导出  表 jsocial.group_user 结构
CREATE TABLE IF NOT EXISTS `group_user` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='群组成员关系';

-- 正在导出表  jsocial.group_user 的数据：~0 rows (大约)

-- 导出  表 jsocial.message_content 结构
...
-- 正在导出表  jsocial.message_content 的数据：~0 rows (大约)

-- 导出  表 jsocial.message_index 结构
...
-- 正在导出表  jsocial.message_index 的数据：~0 rows (大约)

-- 导出  表 jsocial.user 结构
CREATE TABLE IF NOT EXISTS `user` (
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=142 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户';

-- 正在导出表  jsocial.user 的数据：~133 rows (大约)
INSERT IGNORE INTO `user` (`id`, `nickname`, `password`, `gender`, `avatar_url`, `extra`, `created_at`, `updated_at`, `deleted_at`) VALUES
